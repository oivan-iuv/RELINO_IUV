...
public class curp {
    ...
    public static String[] ENTIDAD_FEDERATIVA = {"AGUASCALIENTES","BAJA CALIFORNIA NTE.","BAJA CALIFORNIA SUR","CAMPECHE","COAHUILA","COLIMA","CHIAPAS",
                                                 "CHIHUAHUA","DISTRITO FEDERAL","DURANGO","GUANAJUATO","GUERRERO","HIDALGO","JALISCO","MEXICO","MICHOACAN","MORELOS",
    ...
    public static String[] ENTIDAD_FEDERATIVA_VALOR = {"AS","BC","BS","CC","CL","CM","CS","CH","DF","DG","GT","GR","HG","JC","MC","MN","MS","NT","NL","OC","PL",
                                                       "QT","QR","SP","SL","SR","TC","TS","TL","VZ","YN","ZS","SM","NE"};
...
// -------------------------- STATIC METHODS --------------------------
    ...
    public static String generar(String primerApellido, String segundoApellido, String nombres, String sexo,
        ...
        sexo = trim(sexo.substring(0, 1));//solo valida H o M
        entidadDeNacimiento = trim(entidadDeNacimiento);//solo valida la abreviatura de entidades
        // validar que los datos estan correctors la fecha la valida en formato dd/mm/yyyy
        String error = validarDatos(primerApellido, segundoApellido, nombres, sexo, fechaDeNacimiento, entidadDeNacimiento);
        if (error != null) {
    ...
    // Este ultimo digito es un número generado por la RENAPO por lo que no se puede calcular, solo sugerir
